...
public class Spider extends JFrame {
    ...
    public Spider(){
        setTitle("蜘蛛纸牌 信息安全18(1) 赖晋启 3118005366");
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            x += 101;
            this.getContentPane().add(groundLabel[i]);
        }
    ...
    public void deal()
    {
        ...
        for (int i = 0; i < 10; i++){
            ...
            this.getContentPane().setComponentZOrder(cards[c + i], 1);
    ...
    public void setGroundLabelZOrder(){
        for (int i = 0; i < 10; i++){
            ...
            getContentPane().setComponentZOrder(groundLabel[i], 105 + i);
        }
    }
    ...
    public void haveFinish(int column){
        ...
        do{
            ...
            //将组件移动到容器中指定的顺序索引。 
            getContentPane().setComponentZOrder(card, 1);
