...
public class PKCard extends JLabel implements MouseListener,
    ...
    class Flash extends Thread{
        ...
        public void run(){
            boolean is = false;
            ImageIcon icon = new ImageIcon("C:\\Users\\赖晋启\\IdeaProjects\\大作业\\src\\蜘蛛纸牌\\images/white.gif");
            for (int i = 0; i < 4; i++){
                try{
                    Thread.sleep(200);
                }
    ...
    public PKCard(String name, Spider spider){
        ...
        this.setIcon(new ImageIcon("C:\\Users\\赖晋启\\IdeaProjects\\大作业\\src\\蜘蛛纸牌\\images/rear.gif"));
        this.setSize(71, 96);
    ...
    public void turnFront(){
        this.setIcon(new ImageIcon("C:\\Users\\赖晋启\\IdeaProjects\\大作业\\src\\蜘蛛纸牌\\images/" + name + ".gif"));
        this.isFront = true;
    }
